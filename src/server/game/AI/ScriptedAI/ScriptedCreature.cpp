    ...
    switch(me->GetEntry())
    {
        ...
        case NPC_SARTHARION:                                         // sartharion (calculate box)
            if (fX > 3218.86f && fX < 3275.69f && fY < 572.40f && fY > 484.68f)
                return false;
            break;
        case NPC_GLUTH:                                         // gluth (calculate box)
            if (fX > 3233.0f && fX < 3353.0f && fY < -3086.0f && fY > -3210.0f)
                return false;
            break;
        case NPC_NOTH:                                         // noth (calculate box)
            if (fX > 2621.0f && fX < 2731.0f && fY < -3453.0f && fY > -3556.0f)
                return false;
            break;
        case NPC_HEIGAN:                                         // heigan (calculate box)
